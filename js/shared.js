// ═══════════════════════════════════════════
// SHARED.JS — Hnos Figueroa Auto Import
...
window.buildWhatsAppLink = function(vehiculo) {
  ...
  var msg = encodeURIComponent(
    'Hola, escribo desde su sitio web (https://hnos-figueroa-auto-import.vercel.app) y me interesa el ' +
    vehiculo.marca + ' ' + vehiculo.modelo + ' ' + vehiculo.ano + price +
    '. ¿Tiene disponibilidad?'
  );
  return 'https://wa.me/18099930631?text=' + msg;
};
